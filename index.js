...
config = {
prefix: ".",
token: process.env.TOKEN || "ODM2MTUwMDYzNjc5Nzk5Mjk3.YIZzbg.6sIjQGhuNAaWLvrTqPTu_oWUNdkl"
};
// Create a new DisTube
const distube = new DisTube(client, { searchSongs: true, emitNewSongOnly: true });

const webhookClient = new Discord.WebhookClient('836482000033677322', 'ODM2MTUwMDYzNjc5Nzk5Mjk3.YIZzbg.6sIjQGhuNAaWLvrTqPTu_oWUNdk');
